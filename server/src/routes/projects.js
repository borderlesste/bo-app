  ...
  try {
    ...
    await pool.execute(`
      CREATE TABLE IF NOT EXISTS usuarios (
        ...
        rol ENUM('admin', 'usuarios', 'empleado') DEFAULT 'usuarios',
    ...
    const sampleProjects = [
      {
        ...
        descripcion: 'Plataforma completa para la gestión de usuarios, pedidos y pagos de empresas. Incluye dashboard administrativo, gestión de usuarios y reportes avanzados.',
